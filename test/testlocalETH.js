...
const COIN_WHALE = "0x47ac0Fb4F2D84898e4D9E7b4DaB3C24507a6D503";
...
const pricefeed_weth = '0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419';
let path = "IERC20"
...
describe("Lock", function () {
  ...
  describe ("Deposit and Claim General Test",() => {
    ...
    // let txAdd6 = await Faucet2.addTokenn([LINK,USDT,USDC],[1,1,1],[pricefeed_link,pricefeed_usdt, pricefeed_usdc],[18,6,6]);
    let txAdd6 = await Faucet2.addTokenn(["0x514910771AF9Ca656af840dff83E8264EcF986CA","0xdAC17F958D2ee523a2206206994597C13D831ec7",
    "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"],["0x2c1d072e956AFFC0D435Cb7AC38EF18d24d9127c","0x3E7d1eAB13ad0104d2750B8863b489D65364e32D",
     "0x8fFfFfd4AfB6115b954Bd326cbe7B4BA576818f6"],[1,1,1],[18,6,6]);
...
// const pricefeed_usdc = '0x8fFfFfd4AfB6115b954Bd326cbe7B4BA576818f6';
      ...
      try {
        ...
        console.log(await tokenContract.balanceOf(contractOwner2.address))
        

    }

      const diamondCutFacet = await hre.ethers.getContractAt("DiamondCutFacet", diamond.address);
