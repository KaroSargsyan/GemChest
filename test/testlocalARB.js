...
const COIN_WHALE = "0xc9f32F110e68F7C371280DB8A146EdeB283700a5";
// const COIN_WHALE = "0x72A53cDBBcc1b9efa39c834A540550e23463AAcB";

const pricefeed_link = "0x86E53CF1B870786351Da77A57575e79CB55812CB";
const pricefeed_usdt = '0x3f3f5dF88dC9F13eac63DF89EC16ef6e7E25DdE7';
const pricefeed_usdc = '0x50834F3163758fcC1Df9973b6e91f0F0F0434aD3';
const pricefeed_weth = '0x639Fe6ab55C921f74e7fac1ee960C0B6293ba612';
const pricefeed_dai = '0xc5C8E77B397E531B8EC06BFb0048328B30E9eCfB';
let path = "IERC20"
...
describe("Lock", function () {
  ...
  async function deployTokenFixture(){
    ...
    await Faucet1.initialize(gemChest.address, contractOwner3.address, QUOTER, UNISWAP_V3_ROUTER, "0x82af49447d8a07e3bd95bd0d56f35241523fbab1");
  ...
  describe ("Deposit and Claim General Test",() => {
    it ('1. locked assets should be deposited and claimed_[true, false, false]', async () => {
      const{Faucet1, Faucet2, contractOwner1, gemChest,diamond,dai} = await loadFixture(deployTokenFixture);
      let txAdd3 = await Faucet2.addToken(USDC,1, pricefeed_usdc,6);
      let txAdd5 = await Faucet2.addToken(DAI,1,pricefeed_dai, 18);
      
      console.log(await usdc.balanceOf(coin_whale.address))
      // 259208242465
      // 120000000000
      // 1000000000000000000n
      let txApprove1 = await usdc.connect(coin_whale).approve(diamond.address, 12000000000);
...
it.only ('5.3 locked assets should be deposited and claimed_[false, true, false]_submitBen after claim_ETHER', async () => {
  //Here price manipulation should be done
  //Check to change the price back
  ...
  console.log(await ethers.provider.getBalance(diamond.address),"BALANCE$$$$")
  console.log(await ethers.provider.getBalance(contractOwner1.address),"BALANCE$$$$$")
  let txDeposit1 = await Faucet1.connect(contractOwner1).deposit(depositParams,options);
  console.log("AA!!!!")
  
  //---------------
  9999968699901861021500 
  9999968699901861021500 
     1000000000000000000
...
describe ("MATIC Transactions",() => {
  it ('matic can be locked', async () => {
    ...
    let txAdd4 = await Faucet2.addToken(USDT,1,pricefeed_usdt,6);
